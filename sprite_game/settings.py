...
TEXTS = {"start": "Press _ to start", "inv_full": "You can't hold any more _!", "npc_talk_default":{"say":"Hello. Lovely weather we're having.", "response":["Bye", "Quest"]}, "npc_want": {"say": "I want - _, please.", "response":["Bye", "Accept"]}, "npc_have_quest": "I asked for - _.", "npc_finish_quest":"Oh, thank you! Here, take this.", "gained": "Gained - _ to your inventory.", "removed": "Removed - _ from your inventory.", "quest_prompt":{"say":"Complete quest?", "response":["No", "Yes"]}}
...
NAMES = ["Liz", "Lulu", "Irene", "Carol", "Lewis"]